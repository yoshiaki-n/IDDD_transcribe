...
import com.natswell.sample.ddd.common.serializer.AbstractSerializer;
...
public abstract class AbstractJSONMediaReader {
    ...
    public AbstractJSONMediaReader(JsonObject aRepresentationObject) {
        ...
        this.setRepresentaion(aRepresentationObject);
    }
    ...
    protected JsonElement navigateTo(JsonObject aStartingObject, String... aKeys) {
        if (aKeys.length == 0) {
        ...
        JsonElement element = this.elementFrom(aStartingObject, aKeys[0]);
    ...
    private void initialize(String aJSONRepresentation) {
        ...
        this.setRepresentaion(this.reader().deserialize(aJSONRepresentation));
    }
    
    private void setRepresentaion(JsonObject aRepresentation) {
    ...
    private static class JSONReader extends AbstractSerializer {
        ...
        public JSONReader(boolean isPretty, boolean isCompact) {
