...
public class DomainEventPublisher {
    ...
    public <T> void publish(final T aDomainEvent) {
        if (!this.isPublishing() && this.hasSubscrubers()) {
            ...
            try {
                ...
                for (DomainEventSubscriber<T> subscriber : allSubscribers) {
                    Class<?> subscribedToType = subscriber
    ...
    private boolean hasSubscrubers() {
    ...
    public void setSubscribers(@SuppressWarnings("rawtypes") List subscribers) {
